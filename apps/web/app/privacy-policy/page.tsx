    ...
    <main className="container-shell py-10">
      ...
      <section className="mt-10 grid gap-8">
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">Information We Collect</h2>
        ...
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">How We Use Information</h2>
          <p className="page-reference-body mt-4 text-[#5f6b66]">
        ...
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">Data Protection</h2>
          <p className="page-reference-body mt-4 text-[#5f6b66]">
