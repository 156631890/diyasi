  ...
  return (
    <main className="container-shell py-10">
      ...
      <section className="hero-panel p-7 md:p-10 lg:p-12">
        ...
        <h1 className="section-title mt-2 text-[#1d2521]">Return Policy</h1>
      ...
      <section className="mt-10 grid gap-8">
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">Sample Orders</h2>
        ...
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">Bulk Production Orders</h2>
          <p className="page-reference-body mt-4 text-[#5f6b66]">
        ...
        <article className="editorial-column">
          <h2 className="page-reference-subtitle text-[#1d2521]">Quality Issues</h2>
          <p className="page-reference-body mt-4 text-[#5f6b66]">
