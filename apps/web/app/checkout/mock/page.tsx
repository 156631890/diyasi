  ...
  return (
    <main className="container-shell py-16">
      <section className="card max-w-2xl p-8">
        ...
        <h1 className="heading-font mt-2 text-4xl font-semibold text-[#1d2521]">Mock Checkout</h1>
        ...
        <div className="mt-6 space-y-2 rounded-2xl border border-[rgba(191,144,118,0.26)] p-4 text-sm text-[#5f6b66]">
          <p>
